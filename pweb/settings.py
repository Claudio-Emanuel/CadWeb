...
DATABASES = {
   'default': dj_database_url.parse('postgres://neondb_owner:TEYj9KG3NHMB@ep-long-cloud-a4bekuta-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require')
}
...
USE_L10N = False #Habilita a localização (l10n = localization) no Django, ou seja, 
